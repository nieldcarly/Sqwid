// NOTE: Credit for the following code goes to tbolis (Thomas)
// View his code repository here: https://github.com/tbolis/react-sketch
                    ...
                    <Collapse in={this.state.expandTools}>
                        ...
                        <div className="row">
                            ...
                            >
                                ...
                                <MenuItem value={Tools.Highlighter} key="Highlighter">
                                Highlighter
                                </MenuItem>
                                <MenuItem value={Tools.RectangleLabel} key="Pan">
                                RectangleLabel
                                </MenuItem>
                            </TextField>
                            </div>
